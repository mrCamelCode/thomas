...
To see examples of all these techniques and more (like UI and collisions) in action, check out the [demo](https://github.com/mrCamelCode/space_invaders) I mentioned earlier! It's a simple game inspired by Space Invaders. Note that you may have to update its `Cargo.toml` to point at your local clone of Thomas.
